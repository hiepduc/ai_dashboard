  ...
  const legendItems = [
    {
      ...
      src: markerCluster,
      alt: "Blue circle with number of clustered Air quality stations",
      description: "Air quality station cluster",
    },
    {
      type: "svg",
      svgContent: markerGenerator("station", 16, "legend"),
    ...
    },
    {
      ...
      src: markerPurpleAirCluster,
      alt: "Purple circle with number of clustered PurpleAir sensors",
      description: "PurpleAir sensor cluster",
    },
    {
      type: "svg",
      svgContent: markerGenerator("purpleair", 16),
      description: "PurpleAir sensor",
    },
  ];
    ...
    <div className="dashboard-block__map-key">
      ...
      <div className="map-key">
        {legendItems.map((item, index) => (
          <div key={index} className="map-key-container">
            {item.type === "image" ? (
              <img className="map-key-icon" src={item.src} alt={item.alt} />
            ) : (
              <span
                className="map-key-icon"
            ...
            <span className="map-key-description">{item.description}</span>
          </div>
        ))}
      </div>
    </div>
